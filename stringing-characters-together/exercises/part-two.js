...
let dnaTrimmedUppercase = dnaTrimmed.toUpperCase();
console.log(dnaTrimmedUppercase);
...
let codon = 5;
let numberOfDashes = codon - 1;
let codonPosition = ((codon - 1) * 3) + numberOfDashes;
console.log(dnaTwo.slice(codonPosition, codonPosition+3));
